...
- **2026-07-09** (`20ea389`) — Sync local iOS build number after TestFlight Build 37.

- **2026-07-09** (`69998c1`) — Improve label scan review flow and pharmacy notes parsing.
...
- **2026-07-04** (`256d88c`) — Use wheel time picker in the medication wizard too
...
- **2026-06-30** (`e987892`) — Your commit message here

- **2026-06-29** (`38e31ba`) — v2.0: notifications, sorting, wizard UX, update prompt
...
- **2026-06-23** (`5eac1fd`) — docs: build 17 submitted, 1.0.0 waiting for review
...
- **2026-06-15** (`56fbcaa`) — Fix release black screen by replacing Redirect with imperative navigation.

- **2026-06-15** (`1fcb176`) — Fix black screen on launch by registering the index route.

- **2026-06-15** (`2d03a0d`) — Remove duplicate auth index route that conflicted with app/index.
